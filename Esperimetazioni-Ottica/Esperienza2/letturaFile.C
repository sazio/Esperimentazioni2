...
* Esperimentazioni II - 04/05/2016
  ...
  per eseguire:
  root -l -e 'letturaFile.C++("prisma.txt",40,300,500)'
...
void letturaFile (const std::string &nome_file, const double & nbins = 40, const double& minb = 400, const double& maxb = 500) {
  ifstream myfile;
  ...
  TF1 *fitB = new TF1("gausB","gaus",400,500);
